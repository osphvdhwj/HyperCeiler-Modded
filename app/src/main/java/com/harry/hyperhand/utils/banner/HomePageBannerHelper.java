 ...
 */
package com.harry.hyperhand.utils.banner;

import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getBaseOs;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getRomAuthor;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.isFullSupport;
import static com.harry.hyperhand.common.prefs.PreferenceHeader.notInSelectedScope;
...
public class HomePageBannerHelper {
    ...
    private void isBirthday(Context context, PreferenceCategory preference) {
        ...
        if (currentMonth == Calendar.MAY && currentDay == 1) {
            preference.addPreference(createBannerPreference(
                context,
                R.layout.headtip_hyperhand_birthday
            ));
        }
    }
