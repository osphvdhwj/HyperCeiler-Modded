 ...
 */
package com.harry.hyperhand.ui.page;
...
import com.harry.hyperhand.common.utils.SettingLauncherHelper;
...
import com.harry.hyperhand.common.callback.ModSearchCallback;
import com.harry.hyperhand.common.model.data.ModData;
import com.harry.hyperhand.common.model.adapter.ModSearchAdapter;
import com.harry.hyperhand.ui.page.settings.helper.HomepageEntrance;
...
import com.harry.hyperhand.utils.banner.HomePageBannerHelper;
...
public class HomePageFragment extends DashboardFragment
    ...
    protected void onSearchRequest(View view) {
        ...
        mSearchCallBack.setup(view, mNestedHeaderLayout.getScrollableView(),mContainerView.findViewById(com.harry.hyperhand.R.id.search_result_ll));
    }
    ...
    private boolean isPreferenceHeaderTag(XmlResourceParser xml) {
        return "com.harry.hyperhand.common.prefs.PreferenceHeader".equals(xml.getName());
    }
