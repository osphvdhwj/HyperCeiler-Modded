 ...
 */
package com.harry.hyperhand.ui.page.about.widget;

import static com.harry.hyperhand.common.utils.PersistConfig.isAprilFoolsThemeView;
...
import com.harry.hyperhand.common.utils.SettingsFeatures;
import com.harry.hyperhand.common.view.CubicEaseOutInterpolater;
import com.harry.hyperhand.ui.R;
import com.harry.hyperhand.hook.utils.devicesdk.DisplayUtils;
import com.harry.hyperhand.ui.page.about.controller.LogoAnimationController;
...
public class VersionCard extends FrameLayout implements View.OnClickListener {
    ...
    private void setLogoBlur() {
        if (MiuiBlurUtils.isEnable() && MiuiBlurUtils.isEffectEnable(getContext())) {
            ...
            mIconLogoView.setBackgroundResource(isAprilFoolsThemeView ? R.drawable.ic_hyperhand_logo_sp : R.drawable.ic_hyperhand_logo);
