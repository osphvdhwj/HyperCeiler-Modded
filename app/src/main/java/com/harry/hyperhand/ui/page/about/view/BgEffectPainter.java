 ...
 */
package com.harry.hyperhand.ui.page.about.view;
...
public class BgEffectPainter {
    ...
    private void calcAnimationBound(Context context, View view, ActionBar actionBar) {
        float height = (actionBar != null ? actionBar.getHeight() + 0.0f : 0.0f) + context.getResources().getDimensionPixelSize(com.harry.hyperhand.ui.R.dimen.logo_area_height);
