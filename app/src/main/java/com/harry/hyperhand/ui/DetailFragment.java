...
public class DetailFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setThemeRes(com.harry.hyperhand.ui.R.style.NavigatorSecondaryContentTheme);
    }
    ...
    public View onInflateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.harry.hyperhand.ui.R.layout.fragment_detail, container, false);
    }
    ...
    public void onViewInflated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mEmptyView = view.findViewById(com.harry.hyperhand.ui.R.id.empty);
        ...
        if (args != null) {
            ...
            if (!TextUtils.isEmpty(mFragmentName)) {
                getChildFragmentManager()
                        .beginTransaction()
                        .replace(com.harry.hyperhand.ui.R.id.frame_content, androidx.fragment.app.Fragment.instantiate(requireContext(), mFragmentName, args))
                        .commit();
