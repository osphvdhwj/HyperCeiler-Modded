 ...
 */
package com.harry.hyperhand.ui.page.settings.development;
...
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getBoard;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getBrand;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getCharacteristics;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getDeviceName;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getDeviceToken;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getFingerPrint;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getLanguage;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getLocale;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getManufacturer;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getMarketName;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getModDevice;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getModelName;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getSoc;
import static com.harry.hyperhand.hook.utils.devicesdk.MiDeviceAppUtilsKt.isInternational;
import static com.harry.hyperhand.hook.utils.devicesdk.MiDeviceAppUtilsKt.isLargeUI;
import static com.harry.hyperhand.hook.utils.devicesdk.MiDeviceAppUtilsKt.isPad;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getAndroidVersion;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getBuildDate;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getCurrentUserId;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getHyperOSVersion;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getSystemVersionIncremental;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.getWhoAmI;
import static com.harry.hyperhand.hook.utils.log.LogManager.LOGGER_CHECKER_ERR_CODE;
...
public class DevelopmentDebugInfoFragment extends SettingsPreferenceFragment {
    ...
    public String getDebugInfo() {
        ...
        StringBuilder debugInfo = new StringBuilder("Debug Info by HyperHand");
        debugInfo.append("\n");
