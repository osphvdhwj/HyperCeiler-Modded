...
import com.harry.hyperhand.dashboard.base.fragment.BaseSettingsProxy;
import com.harry.hyperhand.dashboard.base.fragment.SettingsProxy;
import com.harry.hyperhand.hook.module.base.tool.AppsTool;
...
public class NaviBaseActivity extends NavigatorActivity {
    ...
    public void checkTheme() {
        if (AttributeResolver.resolve(this, fan.navigator.R.attr.isNavigatorTheme) < 0) {
            ...
            setTheme(com.harry.hyperhand.ui.R.style.NavigatorActivityTheme);
        }
    }
    ...
    public int getBottomTabMenu() {
        return com.harry.hyperhand.ui.R.menu.bottom_nav_menu;
    }
    ...
    public void onCreatePrimaryNavigation(Navigator navigator, Bundle bundle) {
        ...
        newLabel(getString(com.harry.hyperhand.ui.R.string.navigation_home_title), com.harry.hyperhand.ui.R.drawable.ic_navigation_home, navInfoToHome);
        newLabel(getString(com.harry.hyperhand.ui.R.string.navigation_settings_title), com.harry.hyperhand.ui.R.drawable.ic_navigation_settings, navInfoToSettings);
        newLabel(getString(com.harry.hyperhand.ui.R.string.navigation_about_title), com.harry.hyperhand.ui.R.drawable.ic_navigation_about, navInfoToAbout);
