 ...
 */
package com.harry.hyperhand.ui;

import static com.harry.hyperhand.common.utils.PersistConfig.isLunarNewYearThemeView;
import static com.harry.hyperhand.common.utils.PersistConfig.isNeedGrayView;
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.isTablet;
...
import com.harry.hyperhand.common.prefs.PreferenceHeader;
import com.harry.hyperhand.common.prefs.XmlPreference;
import com.harry.hyperhand.common.utils.DialogHelper;
import com.harry.hyperhand.common.utils.LanguageHelper;
import com.harry.hyperhand.common.utils.search.SearchHelper;
import com.harry.hyperhand.dashboard.SubSettings;
import com.harry.hyperhand.hook.callback.IResult;
import com.harry.hyperhand.hook.safe.CrashData;
import com.harry.hyperhand.hook.utils.BackupUtils;
import com.harry.hyperhand.hook.utils.ThreadPoolManager;
import com.harry.hyperhand.hook.utils.log.LogManager;
import com.harry.hyperhand.hook.utils.shell.ShellInit;
import com.harry.hyperhand.ui.holiday.HolidayHelper;
import com.harry.hyperhand.utils.LogServiceUtils;
import com.harry.hyperhand.utils.PermissionUtils;
import com.harry.hyperhand.utils.XposedActivateHelper;
...
public class HyperHandTabActivity extends NaviBaseActivity
    ...
    private void showSafeModeDialogIfNeeded() {
        if (haveCrashReport()) {
            ...
            String msg = getString(com.harry.hyperhand.ui.R.string.safe_mode_later_desc, appName);
    ...
    private Map<String, String> createAppNameMap() {
        ...
        appNameMap.put("com.android.systemui", getString(com.harry.hyperhand.ui.R.string.system_ui));
        appNameMap.put("com.android.settings", getString(com.harry.hyperhand.ui.R.string.system_settings));
        appNameMap.put("com.miui.home", getString(com.harry.hyperhand.ui.R.string.mihome));
        appNameMap.put("com.hchen.demo", getString(com.harry.hyperhand.ui.R.string.demo));
        appNameMap.put("com.miui.securitycenter", getString(com.harry.hyperhand.ui.R.string.security_center_hyperos));
        ...
        try {
            ...
            switch (requestCode) {
                case BackupUtils.CREATE_DOCUMENT_CODE -> {
                    ...
                    alert.setTitle(com.harry.hyperhand.ui.R.string.backup_success);
                }
                case BackupUtils.OPEN_DOCUMENT_CODE -> {
                    BackupUtils.handleReadDocument(this, data.getData());
                    alert.setTitle(com.harry.hyperhand.ui.R.string.rest_success);
                }
                default -> {
                    return;
                }
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(this);
            switch (requestCode) {
                case BackupUtils.CREATE_DOCUMENT_CODE -> alert.setTitle(com.harry.hyperhand.ui.R.string.backup_failed);
                case BackupUtils.OPEN_DOCUMENT_CODE -> alert.setTitle(com.harry.hyperhand.ui.R.string.rest_failed);
            }
