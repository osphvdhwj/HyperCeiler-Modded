 ...
 */
package com.harry.hyperhand.ui.page.settings;

import static com.harry.hyperhand.hook.utils.PropUtils.getProp;
import static com.harry.hyperhand.ui.page.settings.helper.HomepageEntrance.ANDROID_NS;
...
public class SafeModeFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    String mPkgList = getProp("persist.hyperhand.crash.report");
    ...
    public boolean onPreferenceChange(@NonNull Preference preference, Object o) {
        ...
        if (!key.isEmpty()) {
            ...
            ShellInit.getShell().run("setprop persist.hyperhand.crash.report \"" + mPkgList + "\"").sync();
        }
        return true;
    }
