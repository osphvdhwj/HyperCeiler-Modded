package com.sevtinge.hyperceiler.debloater.utils;
...
public class Utils {
    ...
    public static String getAppStoreURL(Context context) {
        if (sPackageUtils.isPackageInstalled("com.android.vending", context)) {
            return " Google Play: https://play.google.com/store/apps/details?id=com.sevtinge.hyperceiler.debloater";
        } else if (sPackageUtils.isPackageInstalled("org.fdroid.fdroid", context)) {
            return " F-Droid: https://f-droid.org/packages/com.sevtinge.hyperceiler.debloater/";
        } else {
