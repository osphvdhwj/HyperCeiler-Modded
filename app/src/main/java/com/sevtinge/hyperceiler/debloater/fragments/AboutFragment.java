package com.sevtinge.hyperceiler.debloater.fragments;
...
public class AboutFragment extends Fragment {
    ...
    private List<sSerializableItems> getData() {
        ...
        if (sPackageUtils.isPackageInstalled("com.android.vending", requireActivity())) {
            mData.add(new sSerializableItems(sCommonUtils.getDrawable(R.drawable.ic_rate, requireActivity()), getString(R.string.rate_us), getString(R.string.rate_us_Summary), "https://play.google.com/store/apps/details?id=com.sevtinge.hyperceiler.debloater"));
        } else if (sPackageUtils.isPackageInstalled("org.fdroid.fdroid", requireActivity())) {
            mData.add(new sSerializableItems(sCommonUtils.getDrawable(R.drawable.ic_fdroid, requireActivity()), getString(R.string.fdroid), getString(R.string.fdroid_summary), "https://f-droid.org/packages/com.sevtinge.hyperceiler.debloater"));
        } else {
