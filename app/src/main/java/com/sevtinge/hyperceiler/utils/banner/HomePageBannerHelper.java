...
public class HomePageBannerHelper {
    ...
    private boolean getIsOfficialRom() {
        ...
        boolean isXiaomiEu = Objects.equals(host, "xiaomi.eu");
        String device = SystemSDKKt.getDevice();
        if (isXiaomiEu && "redwood".equals(device)) {
            return false;
        }

        return hasRomAuthor || isXiaomiEu || (isNotCustomBaseOs && isNotCustomHost);
    }
