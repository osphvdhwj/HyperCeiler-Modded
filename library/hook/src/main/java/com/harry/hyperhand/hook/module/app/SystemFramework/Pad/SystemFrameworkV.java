 ...
 */
package com.harry.hyperhand.hook.module.app.SystemFramework.Pad;

import com.hchen.database.HookBase;
import com.harry.hyperhand.hook.module.base.BaseModule;
import com.harry.hyperhand.hook.module.hook.GlobalActions;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowAutoStart;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowDisableProtectedPackage;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowUntrustedTouch;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowUntrustedTouchForU;
import com.harry.hyperhand.hook.module.hook.systemframework.AntiQues;
import com.harry.hyperhand.hook.module.hook.systemframework.AppLinkVerify;
import com.harry.hyperhand.hook.module.hook.systemframework.AutoEffectSwitchForSystem;
import com.harry.hyperhand.hook.module.hook.systemframework.BackgroundBlur;
import com.harry.hyperhand.hook.module.hook.systemframework.BypassForceDownloadui;
import com.harry.hyperhand.hook.module.hook.systemframework.BypassForceMiAppStore;
import com.harry.hyperhand.hook.module.hook.systemframework.BypassUnknownSourcesRestrictions;
import com.harry.hyperhand.hook.module.hook.systemframework.CleanOpenMenu;
import com.harry.hyperhand.hook.module.hook.systemframework.CleanProcessTextMenu;
import com.harry.hyperhand.hook.module.hook.systemframework.CleanShareMenu;
import com.harry.hyperhand.hook.module.hook.systemframework.ClipboardWhitelist;
import com.harry.hyperhand.hook.module.hook.systemframework.DeleteOnPostNotification;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableCleaner;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableFreeformBlackList;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableGestureMonitor;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableLowApiCheckForU;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableMiuiLite;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableMiuiWatermark;
import com.harry.hyperhand.hook.module.hook.systemframework.DisablePersistent;
import com.harry.hyperhand.hook.module.hook.systemframework.DisablePinVerifyPer72h;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableThermal;
import com.harry.hyperhand.hook.module.hook.systemframework.DisableVerifyCanBeDisabled;
import com.harry.hyperhand.hook.module.hook.systemframework.EffectBinderProxy;
import com.harry.hyperhand.hook.module.hook.systemframework.FlagSecure;
import com.harry.hyperhand.hook.module.hook.systemframework.FreeformBubble;
import com.harry.hyperhand.hook.module.hook.systemframework.HookEntry;
import com.harry.hyperhand.hook.module.hook.systemframework.LinkTurboToast;
import com.harry.hyperhand.hook.module.hook.systemframework.MultiFreeFormSupported;
import com.harry.hyperhand.hook.module.hook.systemframework.PackagePermissions;
import com.harry.hyperhand.hook.module.hook.systemframework.PstedClipboard;
import com.harry.hyperhand.hook.module.hook.systemframework.QuickScreenshot;
import com.harry.hyperhand.hook.module.hook.systemframework.RemoveSmallWindowRestrictions;
import com.harry.hyperhand.hook.module.hook.systemframework.ScreenRotation;
import com.harry.hyperhand.hook.module.hook.systemframework.SpeedInstall;
import com.harry.hyperhand.hook.module.hook.systemframework.StickyFloatingWindows;
import com.harry.hyperhand.hook.module.hook.systemframework.SystemLockApp;
import com.harry.hyperhand.hook.module.hook.systemframework.ThermalBrightness;
import com.harry.hyperhand.hook.module.hook.systemframework.UseAndroidPackageInstaller;
...
import com.harry.hyperhand.hook.module.hook.systemframework.display.AllDarkMode;
import com.harry.hyperhand.hook.module.hook.systemframework.display.EnhanceRecentsVisibility;
import com.harry.hyperhand.hook.module.hook.systemframework.display.ThemeProvider;
import com.harry.hyperhand.hook.module.hook.systemframework.display.UseAOSPScreenShot;
import com.harry.hyperhand.hook.module.hook.systemframework.freeform.FreeFormCount;
import com.harry.hyperhand.hook.module.hook.systemframework.freeform.OpenAppInFreeForm;
import com.harry.hyperhand.hook.module.hook.systemframework.freeform.UnForegroundPin;
import com.harry.hyperhand.hook.module.hook.systemframework.mipad.IgnoreStylusKeyGesture;
import com.harry.hyperhand.hook.module.hook.systemframework.mipad.RemoveStylusBluetoothRestriction;
import com.harry.hyperhand.hook.module.hook.systemframework.mipad.RestoreEsc;
import com.harry.hyperhand.hook.module.hook.systemframework.mipad.SetGestureNeedFingerNum;
import com.harry.hyperhand.hook.module.hook.systemframework.network.DualNRSupport;
import com.harry.hyperhand.hook.module.hook.systemframework.network.DualSASupport;
import com.harry.hyperhand.hook.module.hook.systemframework.network.N1Band;
import com.harry.hyperhand.hook.module.hook.systemframework.network.N28Band;
import com.harry.hyperhand.hook.module.hook.systemframework.network.N5N8Band;
import com.harry.hyperhand.hook.module.hook.systemframework.volume.VolumeDefaultStream;
import com.harry.hyperhand.hook.module.hook.systemframework.volume.VolumeDisableSafe;
import com.harry.hyperhand.hook.module.hook.systemframework.volume.VolumeFirstPress;
