...
*/
package com.harry.hyperhand.hook.utils.api.miuiStringToast
...
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.IconParams
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.Left
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.Right
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.StringToastBean
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.StringToastBundle
import com.harry.hyperhand.hook.utils.api.miuiStringToast.res.TextParams
    ...
    fun showStringToast(context: Context, text: String?, colorType: Int?) {
        try {
            ...
            val iconParams: IconParams =
                newIconParams(Category.DRAWABLE, "ic_hyperhand", 1, FileType.SVG)
            val right = Right()
