...
import com.harry.hyperhand.hook.utils.prefs.PrefType;
import com.harry.hyperhand.hook.utils.prefs.PrefsChangeObserver;
        ...
        MethodHook hook = new MethodHook() {
            ...
            protected void after(MethodHookParam param) {
                try {
                    ...
                    if (intent.hasExtra("HyperHand") && intent.getBooleanExtra("HyperHand", false))
                        return;
