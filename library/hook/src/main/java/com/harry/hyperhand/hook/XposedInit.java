 ...
 */
package com.harry.hyperhand.hook;

import static com.harry.hyperhand.hook.module.base.tool.AppsTool.getPackageVersionCode;
import static com.harry.hyperhand.hook.module.base.tool.AppsTool.getPackageVersionName;
...
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.isAndroidVersion;
import static com.harry.hyperhand.hook.utils.devicesdk.SystemSDKKt.isHyperOSVersion;
import static com.harry.hyperhand.hook.utils.log.LogManager.logLevelDesc;
import static com.harry.hyperhand.hook.utils.log.XposedLogUtils.logE;
import static com.harry.hyperhand.hook.utils.log.XposedLogUtils.logI;
import static com.harry.hyperhand.hook.utils.prefs.PrefsUtils.mPrefsMap;

import android.os.Process;

import com.hchen.hooktool.HCInit;
import com.harry.hyperhand.hook.module.app.VariousThirdApps;
import com.harry.hyperhand.hook.module.base.BaseModule;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowManageAllNotifications;
import com.harry.hyperhand.hook.module.hook.systemframework.AllowUninstall;
import com.harry.hyperhand.hook.module.hook.systemframework.BackgroundBlurDrawable;
...
import com.harry.hyperhand.hook.module.hook.systemframework.ToastBlur;
import com.harry.hyperhand.hook.module.hook.systemframework.UnlockAlwaysOnDisplay;
import com.harry.hyperhand.hook.module.skip.SystemFrameworkForCorePatch;
import com.harry.hyperhand.hook.safe.CrashHook;
...
import com.harry.hyperhand.module.base.DataBase;
...
public class XposedInit implements IXposedHookZygoteInit, IXposedHookLoadPackage {
    private static final String TAG = "HyperHand";
    ...
    private void androidCrashEventHook(XC_LoadPackage.LoadPackageParam lpparam) {
        if ("android".equals(lpparam.packageName)) {
            XposedBridge.log("[HyperHand][I]: Log level is " + logLevelDesc());
            try {
