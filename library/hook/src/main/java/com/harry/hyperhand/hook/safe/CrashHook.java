...
*/
package com.harry.hyperhand.hook.safe;
...
import com.harry.hyperhand.hook.callback.ITAG;
...
public class CrashHook extends HookTool {
    ...
    private final String ACTION_APP_CRASH = "hyperhand.intent.action.APP_CRASH";
    ...
    private void reportCrashByIntent(ArrayList<JSONObject> report) {
        ...
        ShellInit.init();
        ShellInit.getShell().run("setprop persist.hyperhand.crash.report " + "\"" + stringBuilder + "\"").sync();
    ...
    private Intent getIntent(String abbr) {
        ...
        intent.setPackage("com.harry.hyperhand");
        intent.setClassName("com.harry.hyperhand", "com.harry.hyperhand.safe.CrashActivity");
    ...
    private void setCrashRecord(ArrayList<JSONObject> data) {
        Settings.System.putString(mContext.getContentResolver(), "hyperhand_crash_record_data", data.toString());
    }

    private ArrayList<JSONObject> getCrashRecord() {
        String data = Settings.System.getString(mContext.getContentResolver(), "hyperhand_crash_record_data");
