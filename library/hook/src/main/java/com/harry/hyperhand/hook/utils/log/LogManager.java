...
import static com.harry.hyperhand.hook.utils.devicesdk.DeviceSDKKt.getSerial;
import static com.harry.hyperhand.hook.utils.prefs.PrefsUtils.mPrefsMap;
import static com.harry.hyperhand.hook.utils.prefs.PrefsUtils.mSharedPreferences;
import static com.harry.hyperhand.hook.utils.shell.ShellUtils.rootExecCmd;

import android.util.Log;

import com.harry.hyperhand.hook.BuildConfig;
import com.harry.hyperhand.hook.utils.PropUtils;
...
public class LogManager {
    ...
    private static final String PROP_HYPERHAND_LOG_LEVEL = "persist.hyperhand.log.level";
    ...
    public static void setLogLevel() {
        ...
        PropUtils.setProp(PROP_HYPERHAND_LOG_LEVEL, effectiveLogLevel);
    }
        ...
        try {
            ...
            if (lsposedFound) {
                ...
                if (logFiles.size() == 1) {
                    ...
                    String grepOutput = rootExecCmd("grep -q 'HyperHand' " + filePath + " && echo 'FOUND' || echo 'EMPTY'");
                    if (grepOutput.trim().equals("EMPTY")) {
                        grepOutput = rootExecCmd("grep -q 'hyperhand' " + filePath + " && echo 'FOUND' || echo 'EMPTY'");
                        if (grepOutput.trim().equals("EMPTY")) {
