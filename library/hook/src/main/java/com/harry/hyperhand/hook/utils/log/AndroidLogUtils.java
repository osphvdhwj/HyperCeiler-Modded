 ...
 * 会导致 <java.lang.NoClassDefFoundError: Failed resolution of: Lcom/harry/hyperhand/XposedInit;> 等
 * 日记:
 * 2025/1/3
 * 我的评价是不要限制这个。
 * 2025/1/4
...
public class AndroidLogUtils {
    ...
    private static final int logLevel = PropUtils.getProp("persist.hyperhand.log.level", 3);
