 ...
 */
package com.harry.hyperhand.hook.module.app.Home.Pad;

import com.hchen.database.HookBase;
import com.harry.hyperhand.hook.module.base.BaseModule;
import com.harry.hyperhand.hook.module.hook.home.AnimDurationRatio;
import com.harry.hyperhand.hook.module.hook.home.DisablePrestart;
import com.harry.hyperhand.hook.module.hook.home.FreeFormCountForHome;
import com.harry.hyperhand.hook.module.hook.home.HomePortraitReverse;
import com.harry.hyperhand.hook.module.hook.home.LockApp;
import com.harry.hyperhand.hook.module.hook.home.MaxFreeForm;
import com.harry.hyperhand.hook.module.hook.home.ScreenSwipe;
import com.harry.hyperhand.hook.module.hook.home.SeekPoints;
import com.harry.hyperhand.hook.module.hook.home.SetDeviceLevel;
import com.harry.hyperhand.hook.module.hook.home.StickyFloatingWindowsForHome;
import com.harry.hyperhand.hook.module.hook.home.ToastSlideAgain;
import com.harry.hyperhand.hook.module.hook.home.UnlockHotseatIcon;
import com.harry.hyperhand.hook.module.hook.home.WidgetCornerRadius;
import com.harry.hyperhand.hook.module.hook.home.dock.DisableRecentsIcon;
import com.harry.hyperhand.hook.module.hook.home.dock.DockCustom;
import com.harry.hyperhand.hook.module.hook.home.dock.DockCustomNew;
import com.harry.hyperhand.hook.module.hook.home.dock.FoldDock;
import com.harry.hyperhand.hook.module.hook.home.dock.HideDock;
import com.harry.hyperhand.hook.module.hook.home.dock.ShowDockIconTitle;
import com.harry.hyperhand.hook.module.hook.home.dock.SlideUpOnlyShowDock;
import com.harry.hyperhand.hook.module.hook.home.drawer.AllAppsContainerViewBlur;
import com.harry.hyperhand.hook.module.hook.home.drawer.AllAppsContainerViewSuperBlur;
import com.harry.hyperhand.hook.module.hook.home.drawer.AppDrawer;
import com.harry.hyperhand.hook.module.hook.home.drawer.PinyinArrangement;
import com.harry.hyperhand.hook.module.hook.home.folder.BigFolderIcon;
import com.harry.hyperhand.hook.module.hook.home.folder.BigFolderIconBlur;
import com.harry.hyperhand.hook.module.hook.home.folder.BigFolderIconBlur1x2;
import com.harry.hyperhand.hook.module.hook.home.folder.BigFolderIconBlur2x1;
import com.harry.hyperhand.hook.module.hook.home.folder.BigFolderItemMaxCount;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderAnimation;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderAutoClose;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderBlur;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderColumns;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderShade;
import com.harry.hyperhand.hook.module.hook.home.folder.FolderVerticalSpacing;
import com.harry.hyperhand.hook.module.hook.home.folder.SmallFolderIconBlur;
import com.harry.hyperhand.hook.module.hook.home.folder.UnlockBlurSupported;
import com.harry.hyperhand.hook.module.hook.home.gesture.CornerSlide;
import com.harry.hyperhand.hook.module.hook.home.gesture.DoubleTap;
import com.harry.hyperhand.hook.module.hook.home.gesture.HotSeatSwipe;
import com.harry.hyperhand.hook.module.hook.home.gesture.QuickBack;
import com.harry.hyperhand.hook.module.hook.home.gesture.ShakeDevice;
import com.harry.hyperhand.hook.module.hook.home.layout.HotSeatsHeight;
import com.harry.hyperhand.hook.module.hook.home.layout.HotSeatsMarginBottom;
import com.harry.hyperhand.hook.module.hook.home.layout.HotSeatsMarginTop;
import com.harry.hyperhand.hook.module.hook.home.layout.IndicatorMarginBottom;
import com.harry.hyperhand.hook.module.hook.home.layout.SearchBarMarginBottom;
import com.harry.hyperhand.hook.module.hook.home.layout.SearchBarMarginWidth;
import com.harry.hyperhand.hook.module.hook.home.layout.UnlockGrids;
import com.harry.hyperhand.hook.module.hook.home.layout.WorkspacePadding;
import com.harry.hyperhand.hook.module.hook.home.mipad.EnableHideGestureLine;
import com.harry.hyperhand.hook.module.hook.home.mipad.EnableMoreSetting;
import com.harry.hyperhand.hook.module.hook.home.mipad.SetGestureNeedFingerNum;
import com.harry.hyperhand.hook.module.hook.home.navigation.BackGestureAreaHeight;
import com.harry.hyperhand.hook.module.hook.home.navigation.BackGestureAreaWidth;
import com.harry.hyperhand.hook.module.hook.home.navigation.HideNavigationBar;
import com.harry.hyperhand.hook.module.hook.home.other.AllowShareApk;
import com.harry.hyperhand.hook.module.hook.home.other.AlwaysBlurWallpaper;
import com.harry.hyperhand.hook.module.hook.home.other.AlwaysShowStatusClock;
import com.harry.hyperhand.hook.module.hook.home.other.BlurRadius;
import com.harry.hyperhand.hook.module.hook.home.other.BlurWhenShowShortcutMenu;
import com.harry.hyperhand.hook.module.hook.home.other.DisableHideGoogle;
import com.harry.hyperhand.hook.module.hook.home.other.FreeformShortcutMenu;
import com.harry.hyperhand.hook.module.hook.home.other.HomeMode;
import com.harry.hyperhand.hook.module.hook.home.other.InfiniteScroll;
import com.harry.hyperhand.hook.module.hook.home.other.OptAppLaunchDelay;
import com.harry.hyperhand.hook.module.hook.home.other.OverlapMode;
import com.harry.hyperhand.hook.module.hook.home.other.ShortcutItemCount;
import com.harry.hyperhand.hook.module.hook.home.other.ShowAllHideApp;
import com.harry.hyperhand.hook.module.hook.home.other.TasksShortcutMenu;
import com.harry.hyperhand.hook.module.hook.home.recent.AlwaysShowCleanUp;
import com.harry.hyperhand.hook.module.hook.home.recent.BackgroundBlur;
import com.harry.hyperhand.hook.module.hook.home.recent.BlurLevel;
import com.harry.hyperhand.hook.module.hook.home.recent.CardTextColor;
import com.harry.hyperhand.hook.module.hook.home.recent.CardTextSize;
import com.harry.hyperhand.hook.module.hook.home.recent.FreeformCardBackgroundColor;
import com.harry.hyperhand.hook.module.hook.home.recent.HideCleanUp;
import com.harry.hyperhand.hook.module.hook.home.recent.HideFreeform;
import com.harry.hyperhand.hook.module.hook.home.recent.HideRecentCard;
import com.harry.hyperhand.hook.module.hook.home.recent.HideStatusBarWhenEnterRecent;
import com.harry.hyperhand.hook.module.hook.home.recent.MemInfoShow;
import com.harry.hyperhand.hook.module.hook.home.recent.RealMemory;
import com.harry.hyperhand.hook.module.hook.home.recent.RecentResource;
import com.harry.hyperhand.hook.module.hook.home.recent.RecentText;
import com.harry.hyperhand.hook.module.hook.home.recent.RemoveCardAnim;
import com.harry.hyperhand.hook.module.hook.home.recent.RemoveIcon;
import com.harry.hyperhand.hook.module.hook.home.recent.RemoveLeftShare;
import com.harry.hyperhand.hook.module.hook.home.recent.ShowLaunch;
import com.harry.hyperhand.hook.module.hook.home.recent.TaskViewHorizontal;
import com.harry.hyperhand.hook.module.hook.home.recent.TaskViewVertical;
import com.harry.hyperhand.hook.module.hook.home.recent.UnlockPin;
import com.harry.hyperhand.hook.module.hook.home.title.AnimParamCustom;
import com.harry.hyperhand.hook.module.hook.home.title.AppBlurAnim;
import com.harry.hyperhand.hook.module.hook.home.title.BigIconCorner;
import com.harry.hyperhand.hook.module.hook.home.title.DisableHideFile;
import com.harry.hyperhand.hook.module.hook.home.title.DisableHideTheme;
import com.harry.hyperhand.hook.module.hook.home.title.DownloadAnimation;
import com.harry.hyperhand.hook.module.hook.home.title.EnableIconMonetColor;
import com.harry.hyperhand.hook.module.hook.home.title.EnableIconMonoChrome;
import com.harry.hyperhand.hook.module.hook.home.title.FakeNonDefaultIcon;
import com.harry.hyperhand.hook.module.hook.home.title.HiddenAllTitle;
import com.harry.hyperhand.hook.module.hook.home.title.HideReportText;
import com.harry.hyperhand.hook.module.hook.home.title.IconMessageColorCustom;
import com.harry.hyperhand.hook.module.hook.home.title.IconTitleColor;
import com.harry.hyperhand.hook.module.hook.home.title.IconTitleCustomization;
import com.harry.hyperhand.hook.module.hook.home.title.LargeIconCornerRadius;
import com.harry.hyperhand.hook.module.hook.home.title.NewInstallIndicator;
import com.harry.hyperhand.hook.module.hook.home.title.RecommendAppsSwitch;
import com.harry.hyperhand.hook.module.hook.home.title.TitleFontSize;
import com.harry.hyperhand.hook.module.hook.home.title.TitleMarquee;
import com.harry.hyperhand.hook.module.hook.home.widget.AllWidgetAnimation;
import com.harry.hyperhand.hook.module.hook.home.widget.AllowMoveAllWidgetToMinus;
import com.harry.hyperhand.hook.module.hook.home.widget.AlwaysShowMiuiWidget;
import com.harry.hyperhand.hook.module.hook.home.widget.HideWidgetTitles;
import com.harry.hyperhand.hook.module.hook.home.widget.ResizableWidgets;
import com.harry.hyperhand.hook.module.hook.home.widget.WidgetBlurOpt;
