...
import static com.harry.hyperhand.hook.utils.shell.ShellUtils.checkRootPermission;
    ...
    private void launchActivityWithRoot() {
        if (checkRootPermission() == 0) {
            try {
                ...
                logE("StartActivityWithRootPreference", "com.harry.hyperhand", "Failed to start activity \"" + targetActivityClass + "\" with root", e);
            }
        } else {
