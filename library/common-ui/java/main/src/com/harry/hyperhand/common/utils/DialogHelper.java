 ...
 */
package com.harry.hyperhand.common.utils;
...
import com.harry.hyperhand.hook.utils.shell.ShellExec;
import com.harry.hyperhand.hook.utils.shell.ShellInit;
import com.harry.hyperhand.common.view.RestartAlertDialog;
...
public class DialogHelper {
    ...
    public static void showCrashReportDialog(Activity activity, View view) {
        ...
        builder.setPositiveButton(R.string.safe_mode_cancel, (dialog, which) -> {
                    ...
                    shellExec.run("setprop persist.hyperhand.crash.report \"\"").sync();
                    activity.finish();
                });
    ...
    public static void showSafeModeDialog(Context context, String msg) {
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.safe_mode_cancel, (dialog, which) -> {
                    ShellInit.getShell().run("setprop persist.hyperhand.crash.report \"\"").sync();
