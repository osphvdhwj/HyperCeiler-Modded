...
public class CtaUtils {
    ...
    public static void setCtaEnabled(Context context) {
        SharedPreferences.Editor edit = context.getSharedPreferences("HyperHand_Permission", 0).edit();
    ...
    public static boolean isCtaEnabled(Context context) {
        return context.getSharedPreferences("HyperHand_Permission", 0).getBoolean("key_new_cta_open", false);
    }
    ...
    public static boolean showCtaDialog(Activity activity, int requestCode) {
        ...
        intent.putExtra("user_agreement", "https://hyperhand.harry.com/Protocol");
        intent.putExtra("privacy_policy", "https://hyperhand.harry.com/Privacy");
