...
import com.harry.hyperhand.hook.provider.SharedPrefsProvider;
import com.harry.hyperhand.hook.utils.BitmapUtils;
import com.harry.hyperhand.hook.utils.ContextUtils;
...
public class PackagesUtils {
    ...
    public static List<AppData> getOpenWithApps() {
        ...
        mainIntent.putExtra("HyperHand", true);
        ...
        mainIntent.putExtra(Intent.EXTRA_TEXT, "HyperHand is the best!");
        mainIntent.setType("*/*");
